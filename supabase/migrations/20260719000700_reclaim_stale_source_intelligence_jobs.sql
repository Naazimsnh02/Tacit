-- Reclaim source-intelligence jobs left in "running" when a worker dies
-- (e.g. docker compose down mid-job). Without this, interpretation stays stuck
-- forever and the package cannot finish.
...
begin
  ...
  where job.status = 'running'
    and job.kind in ('source_interpretation', 'cross_source_understanding')
