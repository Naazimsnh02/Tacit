...
export function WorkspaceShell({ children, active = 'Sources', projectId, projectName = 'Project', versionId, mode = 'demo' }: { readonly children: ReactNode; readonly active?: WorkspaceNavigationLabel | 'Overview' | 'Observe' | 'Discover' | 'Workflow' | 'Approvals' | 'Impact'; readonly projectId?: string; readonly projectName?: string; readonly versionId?: string; readonly mode?: 'demo' | 'production' }) {
